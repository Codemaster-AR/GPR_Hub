...
def clear_screen():
    ...
    # Command is 'cls' on Windows, 'clear' on Linux/macOS
...
def main():
    ...
    while True:
        ...
        if user_input_terminal in ["commands"]:
            ...
            print("GPR Reader Python edition - Version 2.0.0")
            print ("Changelog:")
            print ("- Added Gemini GPR Image Analyzer feature.")
            print ("- Improved CLI usability and error handling.")
            print ("- Added clear screen functionality.")
            print ("- Connected and developed machine learning GPR determiner GUI website link.")
            print ("- Revised commands and fixed bugs from previous versions.")
