...
| |_| |  __/|  _ <  |  _  | |_| | |_) |  Python CLI Edition
 \____|_|   |_| \_\ |_| |_|\__,_|_.__/ 
    ...
    cinetext_type(text, 0.005)
    text = (f"{Fore.BLUE}https://github.com/codemaster-ar/gpr_hub{Style.RESET_ALL}.")
    cinetext_type(text, 0.005)
    time.sleep(0.5)
...
def main():
    ...
    while True:
        ...
        if user_input_terminal in ["commands"]:
            ...
            print("gui_ml_gpr     - Opens the GUI website for a machine learning based GPR determiner. ")
            ...
            print (f"{Style.Bright}Python imports:")
            print("1. os")
            print("2. sys")
            print("3. time")
            print("4. json")
            print("5. textwrap")
            print("6. urllib")
            print("7. urllib.request")
            print("8. urllib.error")
            print("9. getpass")
            print("10. matplotlib")
            print("11. numpy")
            print("12. genai")
            ...
            print("16. webbrowser")
            print("17. keyboard")
            print("18. KeyboardGate")
            print("19. ez_background_music")
            print ("\n")
        elif user_input_terminal == ["help", "troubleshoot", "error", "errors"]:
...
#     playsound("/Users/Anay_Rustogi/Desktop/Mystery Miners - GPR Reader/Python_edition/GPR_Reader_Python_Edition_v3/Incredulity-chosic.com_.mp3", block=False)
#     clear_screen()
#     main()
